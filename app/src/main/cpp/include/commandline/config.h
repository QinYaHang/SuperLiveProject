...
#define FFMPEG_CONFIGURATION "--prefix=./android15/armeabi-v7a --target-os=android --arch=arm --cpu=armv7-a --sysroot=/root/ff/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/sysroot --extra-cflags='-I/root/ff/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -fPIC -DANDROID -mfpu=neon -mfloat-abi=softfp -march=armv7-a' --cc=/root/ff/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang --cxx=/root/ff/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang++ --enable-shared --enable-runtime-cpudetect --enable-gpl --enable-small --enable-cross-compile --enable-asm --enable-neon --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-hwaccels --disable-debug --disable-static --disable-doc --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-postproc --disable-avdevice --disable-symver --disable-stripping"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "./android15/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "./android15/armeabi-v7a/share/ffmpeg"
