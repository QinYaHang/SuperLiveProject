...
public class ImageUtil {
    ...
    public static byte[] yuvToNv210(byte[] y, byte[] u, byte[] v, int stride, int height) {
    ...
    //    nv21ToNV12
    public static void yuvToNv21(byte[] y, byte[] u, byte[] v, byte[] nv21, int stride,
                                 int height) {
...
//
    ...
    public static byte[] nv21_rotate_to_90(byte[] nv21_data, byte[] nv21_rotated, int width,
                                           int height) {
